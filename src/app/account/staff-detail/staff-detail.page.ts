...
export class StaffDetailPage implements OnInit {
  ...
  constructor(private router:Router,private activatedRouter: ActivatedRoute,private alertController: AlertController, private staffDetailLoadingControl: LoadingController, private formBuilder: FormBuilder, private toastController: ToastController) { }
  ...
  async createUpdateForm(staffDetail: any) {
    this.updateForm = this.formBuilder.group({
      ...
      lastName: new FormControl(staffDetail['lastName'], [
        Validators.required
      ]),
      ...
      email: new FormControl(staffDetail['email'], [
        Validators.required
      ]),
      gender: new FormControl({ value: staffDetail['gender'], disabled: true }, [
        Validators.required
      ]),
      bloodGroup: new FormControl({ value: staffDetail['bloodGroup'], disabled: true }, [
        Validators.required
      ]),
      ...
      role: new FormControl(staffDetail['role'], [
        Validators.required
      ]),
      isActive: new FormControl(staffDetail['isActive'], [
        Validators.required
      ]),
        ...
        },
        {
          ...
          handler: async () => {
            ...
            if (this.isProfilePicChanged) {
              ...
              this.updateForm.value['profilePic'] = this.staffDetail['profilePic']
